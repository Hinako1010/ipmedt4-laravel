      ...
      {!!Form::model($diaryentry, ['action'=>'DiaryEntryController@store'])!!}
        ...
        <div class="row">
          ...
          <div class="form-group col-xs-4">
            ...
            <label id="cut_label" for="cut" class="css-label">Snee</label>
          </div>
          <div class="form-group col-xs-4">
            <input id="tickbite" type="checkbox" class="css-checkbox"  name="tickbite" value="1">
            <label id="tickbite_label" for="tickbite" class="css-label">Tekenbeet</label>
          </div>
          <div class="form-group col-xs-4">
            <input id="skinrash" type="checkbox" name="skinrash" value="1" class="css-checkbox">
            <label id="skinrash_label" for="skinrash" class="css-label">Huiduitslag</label>
          </div>
        </div>
        <div class="row">
          ...
          <div class="form-group col-xs-4">
            ...
            <label id="headache_label" for="headache" class="css-label">Hoofdpijn</label>
          </div>
          <div class="form-group col-xs-4">
            <input id="shoulderpain" type="checkbox" class="css-checkbox" name="shoulderpain" value="1">
            <label id="shoulderpain_label" for="shoulderpain" class="css-label">Gewrichtspijn (schouder)</label>
          </div>
          <div class="form-group col-xs-4">
            <input id="elbowpain" type="checkbox" class="css-checkbox" name="elbowpain" value="1">
            <label id="elbowpain_label" for="elbowpain" class="css-label">Gewrichtspijn (elleboog)</label>
          </div>
        </div>
        <div class="row">
          ...
          <div class="form-group col-xs-4">
            ...
            <label id="hippain_label" for="hippain" class="css-label">Pijn aan heupen</label>
          </div>
          <div class="form-group col-xs-4">
            <input id="thighpain" type="checkbox" class="css-checkbox" name="thighpain" value="1">
            <label id="thighpain_label" for="thighpain" class="css-label">Pijn aan bovenbeen</label>
          </div>
          <div class="form-group col-xs-4">
            <input id="kneepain" type="checkbox" class="css-checkbox" name="kneepain" value="1">
            <label id="kneepain_label" for="kneepain" class="css-label">Gewrichtspijn (knie)</label>
          </div>
          <div class="form-group col-xs-4">
            <input id="shinpain" type="checkbox" class="css-checkbox" name="shinpain" value="1">
            <label id="shinpain_label" for="shinpain" class="css-label">Pijn aan onderbeen</label>
          </div>
        </div>
        <div class="form-group">
          <h2>Notities</h2>
